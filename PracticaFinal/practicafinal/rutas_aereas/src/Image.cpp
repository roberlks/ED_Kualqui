...
Image Image::Rota(double angulo)
{
    double rads = angulo;
    ...
    ccorners[0] = 0;
    ccorners[2] = 0;
    rcorners[2] = this->num_filas() - 1;
    rcorners[3] = this->num_filas() - 1;
    ccorners[1] = this->num_cols() - 1;
    ccorners[3] = this->num_cols() - 1;
    new_row_min = 0;
    new_col_min = 0;
    new_row_max = 0;
    new_col_max = 0;
    ...
    for (int rows = 0; rows < newimgrows; rows++)
    {
        for (int cols = 0; cols < newimgcols; cols++)
        {
            ...
            if ((old_row >= 0) && (old_row < this->num_filas()) &&
                (old_col >= 0) && (old_col < this->num_cols()))
            {
